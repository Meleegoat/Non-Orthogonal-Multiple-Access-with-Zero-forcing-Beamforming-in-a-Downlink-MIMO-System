...
hold on
name2=plot([4,16,36,64,128],R_NConvtot,'-.ob','LineWidth',1);
hold on
end

legend([name1,name3,name2],["NOMA-BF(\rho=0.75)","Conventional-BF(\rho=0.75)","Conventional-BF(NOMA users)(\rho=0.75)"]);
