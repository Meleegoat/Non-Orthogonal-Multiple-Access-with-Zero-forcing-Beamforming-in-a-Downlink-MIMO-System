...
if p==0.85
name4=plot([4,16,36,64,128],R_NOMAtot,'-*r','LineWidth',1);
hold on

name6=plot([4,16,36,64,128],R_Convtot,'-.*k','LineWidth',1);
hold on
end
if p==0.95
name7=plot([4,16,36,64,128],R_NOMAtot,'-^r','LineWidth',1);
hold on

name9=plot([4,16,36,64,128],R_Convtot,'-.^k','LineWidth',1);
hold on

legend([name1,name4,name7,name3,name6,name9], ["NOMA-BF(\rho=0.75)", ...
    "NOMA-BF(\rho=0.85)","NOMA-BF(\rho=0.95)","Conventional-BF(\rho=0.75)", ...
    "conventional-BF(\rho=0.85)","conventional-BF(\rho=0.95)" ]);
